...
export const sampleGroups = [
  {
    group_name: "LFG",
    group_id: "ta70s3d7-7bd6-dd9f-b9d4-3bdcbdae844b",
    group_img: nopic,
    group_genre: "LFG",
    group_description: "LFG general.",
    group_tags: ["LFG"],
  ...
  {
    group_name: "Oddballs",
    group_id: "ta7ss3d7-1bd6-d33f-b9d4-3bscbd4e844b",
    group_img: nopic,
    group_genre: "Random",
    group_description: "Random oddities and stuff.",
    group_tags: ["random"],
    date_created: "06/10/2020",
    members_list: ["YesMasta74", "StrangeAndFleek"],
    group_members: [
      {
